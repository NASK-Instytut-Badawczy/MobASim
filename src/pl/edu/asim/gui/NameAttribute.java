...
public class NameAttribute implements DocumentListener {
	...
	public JPanel show() {
		...
		String nameLabel = father.getNameLabel();

		JLabel label = (nameLabel == null || nameLabel.equals("")) ? new JLabel(
				title) : new JLabel(nameLabel);
	...
	public void insertUpdate(DocumentEvent e) {
		father.setName(field.getText());
		father.getSourceElementData().setName(field.getText());
		attribute.getModeler().tree.getModel().valueForPathChanged(
				new TreePath(father), field.getText());
	}
